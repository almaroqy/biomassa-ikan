...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>tema/css/tambah_biota.css">
    ...
    <main">
        <div class="container text-center">
            ...
            <div class="row justify-content-center">
                <div class="col-md-7">
                    <h1>Tambah Data Biota</h1>
                    <div class="tmbh-bio ">
                        <form action="<?= base_url('tambahbiota/registration') ?>" autocomplete="off" method="POST">
