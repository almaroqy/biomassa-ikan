...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>tema/css/pakan.css">
    <title>Pakan</title>
</head>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tb">
                        <ul>
                            <li><a href="<?php echo base_url(); ?>tambahpakan">Tambah Data</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="desc-position">
                        <div class="row">
                            ...
                            ?>
                                <div class="col-md-5 py-5 px-5" style="background-color: #6EABB8; margin-right: 1%; margin-top: 1%;">
                                    <div class="row">
                                        <div class="col-md-9 ">
                                            <p>Nama Pakan: <?= $pak->jenis_pakan ?></p>
                                            <p>Keterangan: <?= $pak->deskripsi ?></p>
                                            <?php echo anchor('pakan/edit/' . $pak->pakan_id, 'Edit'); ?> |
                                            <a onclick="return confirm ('Apakah Anda Yakin Ingin Menghapus?')" <?php echo anchor('pakan/hapus/' . $pak->pakan_id, 'Hapus'); ?> </a>
                                        </div>
                                    </div>
                                </div>
                            <?php } ?>
