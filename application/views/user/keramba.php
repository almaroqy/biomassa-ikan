...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>tema/css/keramba.css">
    <title>Keramba</title>
</head>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning" <?php echo anchor('keramba/edit/' . $ker->keramba_id, 'Edit'); ?> </a>
                                            <a class="btn btn-danger" onclick="return confirm ('Apakah Anda Yakin Ingin Menghapus?')" <?php echo anchor('keramba/hapus/' . $ker->keramba_id, 'Hapus'); ?> </a>
                                    </td>
                                </tr>
                            <?php } ?>
